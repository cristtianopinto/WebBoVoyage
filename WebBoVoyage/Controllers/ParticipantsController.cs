...
namespace WebBoVoyage.Controllers
{
    public class ParticipantsController : ApiController
    {
        ...
        // GET: api/Participants
        [Route("api/Participants/search/{id?}")]
        public IQueryable<Participant> GetParticipantsByIdDossier(int id)
        {
            return db.Participants.Where(x => x.IdDossierReservation == id);
        }
